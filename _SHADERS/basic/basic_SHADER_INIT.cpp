    ...
    "    gl_FragColor             = (texture2D(Texture1,  varTexcoord.xy) * highp vec4(NdotL1)-0.1 + ( texture2D(Texture1,  varTexcoord.xy) * 0.5 * highp vec4(max(pow(NdotL1, 10.0), 0.0)))) - texture2D(Texture1,  varTexcoord.xy) *invert_NdotL1*.35;                                                                                               \n" 
